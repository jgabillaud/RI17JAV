	...
	public static void main(String[] args) {
		...
		System.out.println(
							String.format("boolean : %b \n" +
										  ...
										  "entier : %d \n" +
										  "entier en hexadécimal : %x \n" +
										  "entier en ocatl: %o \n" +
										  "décimal : %f \n" +
										  "décimal précis au dixième : %.1f \n" +
										  "décimal au format scientifique : %e \n", 
										  b,s,i,i,i,d,d,d)
						  );
		
		//Déclarer une chaine de caractères avec un Text Block
		String chaineTextBlock1="""
				Bonjour,
				ceci est une chaine sur plusieurs 
				lignes (affichée sur plusieurs lignes)""";
		System.out.println("chaineTextBlock 1 = "+chaineTextBlock1);
		String chaineTextBlock2="""
				Bonjour, \
				ceci est une chaine sur plusieurs \
				lignes (affichée sur une ligne)""";
		System.out.println("chaineTextBlock 2 = "+chaineTextBlock2);
		
		//Rendre variable un Textblock
		String uneValeur = "ensoleillé" ;
		//String meteo = """
		//			le temps est 
		//			${uneValeur}"""; Ne fonctionne pas, l'interpolation n'existe pas
		String meteo ="""
					le temps est 
